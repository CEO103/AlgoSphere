...
def display_algo_tc(algorithm_name):
    ...
    tc_code_paths = {
    "DFS": os.path.join(base_dir,  "e_plus_v.py"),
    "BFS": os.path.join(base_dir, "e_plus_v.py"),
    "Topo Sort": os.path.join(base_dir,  "e_plus_v.py"),
    "Dijkstra": os.path.join(base_dir,  "e_log_v.py"),
    "Bellman Ford": os.path.join(base_dir,  "ev.py"),
    "Prims": os.path.join(base_dir,  "e_log_v.py"),
    "Kruskals": os.path.join(base_dir,  "e_log_v.py"),
    "Kosaraju": os.path.join(base_dir,  "e_plus_v.py")
    }
    tc_code_paths = {
